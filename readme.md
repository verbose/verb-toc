# verb-toc [![NPM version](https://img.shields.io/npm/v/verb-toc.svg)](https://www.npmjs.com/package/verb-toc) [![Build Status](https://img.shields.io/travis/verbose/verb-toc.svg)](https://travis-ci.org/verbose/verb-toc)
